			...
			<div class="card-body">	
				<div class="row">
					<div class="col-md-12 mb-2">
						...
						{{ Form::text('title',old('title'),['class' => 'form-control title ','required' => 'true'])}}	
						@error('title')
				    ...
				    <div id="add_article" class="container tab-pane active">
				    	<div class="row form-group">		    		
				    		...
				    		<div class="col-md-12 mb-2">
				    			...
				    			{{Form::textarea('body',old('body'),['class' => 'form-control body' , 'rows' => '4' , 'cols' => '4','id'=>'mytextarea'])}}
				    		</div>
				    		<div class="col-md-12 mb-2">
				    			{{Form::label('tag_id','Tags')}}
				    			{{Form::select('tag_id[]',$tags,'',['class' => 'form-control','id' => 'tags','multiple' => 'multiple'])}}
				    		</div>
				    	</div>
				    </div>
				      	...
				      	<div class="row">
				      		<div class="col-md-8 m-auto">
				      			<div class="row form-group mb-3">
									...
									<div class="col-md-8">
										{{ Form::radio('directory_show', '1', old('directory_show') == '1' ? true : false, ['id' => 'dir_radio1']) }}
										{{ Form::label('dir_radio1', 'Yes') }} 
										{{ Form::radio('directory_show', '0', old('directory_show') == '0' ? true : true, ['id' => 'dir_radio2','class'=>'ml-4']) }} 
								...
								<div class="from-group row mb-3">
									...
									<div class="col-md-8 ">
										{{ Form::text('directory_bname',old('directory_bname'),['class' => 'form-control'])}}
								...
								<div class="from-group row mb-3">
									...
									<div class="col-md-8 ">
										{{ Form::text('directory_cname',old('directory_cname'),['class' => 'form-control'])}}
								...
								<div class="from-group row mb-3">
									...
									<div class="col-md-8 ">
										{{ Form::text('directory_email',old('directory_email'),['class' => 'form-control'])}}
								...
								<div class="from-group row mb-3">
									...
									<div class="col-md-8 ">
										{{ Form::text('directory_address',old('directory_address'),['class' => 'form-control'])}}
								...
								<div class="from-group row mb-3">
									...
									<div class="col-md-8 ">
										{{Form::select('directory_country',$countries,'',['class' => 'form-control directory_country'])}}
								...
								<div class="from-group row mb-3">
									...
									<div class="col-md-8 ">
										{{ Form::text('directory_zip',old('directory_zip'),['class' => 'form-control'])}}
										@error('directory_zip')
			                                <span class="text-danger" role="alert">
			                                    <strong>{{ $message }}</strong>
			                                </span>
								...
								<div class="from-group row mb-3">
									...
									<div class="col-md-8 ">
										{{ Form::text('directory_tele',old('directory_tele'),['class' => 'form-control'])}}
								...
								<div class="from-group row mb-3">
									...
									<div class="col-md-8 ">
										{{ Form::text('directory_fax',old('directory_fax'),['class' => 'form-control'])}}
										@error('directory_fax')
			                                <span class="text-danger" role="alert">
			                                    <strong>{{ $message }}</strong>
			                                </span>
								...
								<div class="from-group row mb-3">
									...
									<div class="col-md-8 ">
										{{ Form::text('directory_website',old('directory_website'),['class' => 'form-control'])}}
						...
						<div class="row" id="options-content">
							<div class="col-md-6">						
								...
								<div class="advanced_form">
									<div class="from-group row mb-3">
										...
										<div class="col-md-8 ">
											{{ Form::text('publish_date',old('publish_date') ?? date('Y-m-d'),['class' => 'form-control datepicker'])}}
											@error('publish_date')
				                                <span class="text-danger" role="alert">
				                                    <strong>{{ $message }}</strong>
				                                </span>
									...
									<div class="row form-group mb-3">
										...
										<div class="col-md-8">
											{{ Form::radio('show_comment', '1', old('show_comment') == '1' ? true : true, ['id' => 'radio1']) }} 
											{{ Form::label('radio1', 'Yes') }} 
											{{ Form::radio('show_comment', '0', old('show_comment') == '0' ? true : false, ['id' => 'radio2','class'=>'ml-4']) }} 
									...
									<div class="row form-group mb-3">
										...
										<div class="col-md-8">
											{{ Form::radio('show_poll', '1', old('show_poll') == '1' ? true : true, ['id' => 'radio3']) }} 
											{{ Form::label('radio3', 'Yes') }} 
											{{ Form::radio('show_poll', '0', old('show_poll') == '0' ? true : false, ['id' => 'radio4','class'=>'ml-4']) }} 
									...
									<div class="row form-group mb-3">
										...
										<div class="col-md-8">
											{{ Form::radio('rss_feed', '1', old('rss_feed') == '1' ? true : true, ['id' => 'radio5']) }} 
											{{ Form::label('radio5', 'Yes') }} 
											{{ Form::radio('rss_feed', '0', old('rss_feed') == '0' ? true : false, ['id' => 'radio6','class'=>'ml-4']) }} 
									...
									<div class="row form-group mb-3">
										...
										<div class="col-md-8">
											{{ Form::radio('show_author', '1', old('show_author') == '1' ? true : true, ['id' => 'radio7']) }} 
											{{ Form::label('radio7', 'Yes') }} 
											{{ Form::radio('show_author', '0', old('show_author') == '0' ? true : false, ['id' => 'radio8','class'=>'ml-4']) }} 
									...
									<div class="row form-group mb-3">
										...
										<div class="col-md-8">
											{{ Form::radio('show_abstract_image', '1', old('show_abstract_image') == '1' ? true : true, ['id' => 'radio9']) }} 
											{{ Form::label('radio9', 'Yes') }} 
											{{ Form::radio('show_abstract_image', '0', old('show_abstract_image') == '0' ? true : false, ['id' => 'radio10','class'=>'ml-4']) }} 
							...
							<div class="col-md-6">
								...
								<div class="row form-group mb-3">
									...
									<div class="col-md-8 ">
										{{ Form::text('sef_title',old('sef_title'),['class' => 'form-control'])}}
										@error('sef_title')
			                                <span class="text-danger" role="alert">
			                                    <strong>{{ $message }}</strong>
			                                </span>
								...
								<div class="row form-group mb-3">
									...
									<div class="col-md-8 ">
										{{ Form::textarea('meta_descriptions',old('meta_descriptions'),['class' => 'form-control','cols' => '3', 'rows' => '5'])}}
...
<script>
	$(document).ready(function() {
	 ...
	 //    var country_code = "{{old('country_code') !='' ? old('country_code') : '102'}}";
