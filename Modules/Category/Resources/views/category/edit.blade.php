	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title">Edit Category <a href="{{url('/category')}}" class="btn btn-sm btn-primary pull-right">Back</a></h4>
			...
			<div class="card-body">
				...
				<div class="col-md-10 m-auto">
					...
					<div class="from-group row mb-4">
						...
						<div class="col-md-8 ">
							{{ Form::text('category_name',old('category_name') ?? $categoryInfo->category_name,['class' => 'form-control category_name'])}}
							@error('category_name')
					...
					<div class="from-group row mb-4">
						...
						<div class="col-md-8 ">
							{{ Form::text('sefriendly',old('sefriendly') ?? $categoryInfo->sefriendly,['class' => 'form-control sefriendly'])}}
							@error('sefriendly')
                                <span class="text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
					...
					<div class="advanced_form">
						<div class="from-group row mb-4">
							...
							<div class="col-md-8 ">
								{{ Form::text('article_num',old('article_num') ?? $categoryInfo->article_num,['class' => 'form-control'])}}
								@error('article_num')
	                                <span class="text-danger" role="alert">
	                                    <strong>{{ $message }}</strong>
	                                </span>
						...
						<div class="from-group row mb-4">
							...
							<div class="col-md-8 ">								
			                    {{ Form::radio('view_subcat', '1', old('view_subcat') == '1' ? true : ($categoryInfo->view_subcat == '1' ? true : false) , ['id' => 'radio1']) }} 
			                    {{ Form::label('radio1', 'Yes') }} 
			                    {{ Form::radio('view_subcat', '0', old('view_subcat') == '0' ? true : ($categoryInfo->view_subcat == '0' ? true : false), ['id' => 'radio2','class'=>'ml-4']) }} 
						...
						<div class="from-group row mb-4">
							...
							<div class="col-md-8 ">								
			                   {{ Form::text('cat_cust_title',old('cat_cust_title') ?? $categoryInfo->cat_cust_title,['class' => 'form-control'])}}
						...
						<div class="from-group row mb-4">
							...
							<div class="col-md-8 ">								
			                   {{ Form::text('cat_cust_keywords',old('cat_cust_keywords') ?? $categoryInfo->cat_cust_keywords,['class' => 'form-control'])}}
						...
						<div class="from-group row mb-4">
							...
							<div class="col-md-8 ">								
			                   {{ Form::text('cat_cust_desc',old('cat_cust_desc') ?? $categoryInfo->cat_cust_desc,['class' => 'form-control'])}}
			                    @error('cat_cust_desc')
	                                <span class="text-danger" role="alert">
	                                    <strong>{{ $message }}</strong>
	                                </span>
